...
<!-- <center><H3><strrong>TAMBAH DATA</strrong></H3></Center> -->
   ...
   <th> <label for="Nama" class="col-sm-2 col-form-label"><strong>Nama          :</strong></th></label>
    <div class="col-sm-10">
        <input type="text" class="form-control" name='Nama' value="{{ Session::get('Nama') }}"  id="Nama">
    </div>
</div>
<div class="mb-3 row">
    <label for="waktu" class="col-sm-2 col-form-label"><strong> Tanggal          :</strong></label>
    <div class="col-sm-10">
        <input type="date" class="form-control" name='waktu' value="{{ Session::get('waktu') }}" id="waktu">
    </div>
</div>
<div class="mb-3 row">
