...
(43, '2023_01_10_031123_create_posts_table', 1),
(44, '2023_01_11_075158_create_ruangan_table', 1),
(45, '2023_01_30_080544_create_pendataans_table', 2),
(46, '2023_02_01_001311_create_cetaks_table', 2);
...
CREATE TABLE `pendataan` (
  ...
  `nomor_bidang` varchar(255) NOT NULL,
  `nomor_surat` varchar(255) NOT NULL,
  `asal_surat` varchar(255) NOT NULL,
  `perihal` varchar(255) NOT NULL,
  `disposisi_kabid` varchar(255) NOT NULL,
...
ALTER TABLE `ruangan`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `ruangan_nip_unique` (`NIP`);
